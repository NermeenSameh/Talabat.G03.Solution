...
namespace Route.Talabat.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240504223131_OrderModule01")]
    partial class OrderModule01
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Route.Talabat.Core.Entities.Order_Aggregate.DeliveryMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Route.Talabat.Core.Entities.Order_Aggregate.Order", b =>
                {
                    b.HasOne("Route.Talabat.Core.Entities.Order_Aggregate.DeliveryMethod", "DeliveryMethod")
                        .WithMany()
            ...
            modelBuilder.Entity("Route.Talabat.Core.Entities.Order_Aggregate.OrderItem", b =>
                {
                    ...
                    b.OwnsOne("Route.Talabat.Core.Entities.Order_Aggregate.ProductItemOrder", "Product", b1 =>
                        {
            ...
            modelBuilder.Entity("Route.Talabat.Core.Entities.Product.Product", b =>
                {
                    b.HasOne("Route.Talabat.Core.Entities.Product.ProductBrand", "Brands")
                        .WithMany()
